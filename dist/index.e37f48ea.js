...
var _hourlyView = require("./views/hourlyView");
var _hourlyViewDefault = parcelHelpers.interopDefault(_hourlyView);
var _weeklyView = require("./views/weeklyView");
...
const controlWeather = async ()=>{
    try {
        ...
        _currentViewDefault.default.renderCurrentWeather(_model.state.currentWeather, _model.state.lang);
...
},{"./model":"Y4A21","./views/currentView":"aquYQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@babel/polyfill":"dTCHC","./views/searchView":"9OQAM","./views/hourlyView":"8gGt7","./views/weeklyView":"aOUJX","./views/mainView":"cuFOb"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "setStateLang", ()=>setStateLang
);
...
class currentView extends _viewDefault.default {
  ...
  <div class="second-categories">
    ...
    <div class="column-wrapper">
      ...
      <p>${lang === 'fr' ? _helpers.convertKMH(data.wind) : _helpers.convertMPH(data.wind)}</p>
    </div>
    <div class="column-wrapper">
      <p class="icon">Feels</p>
      <p>${lang === 'fr' ? _helpers.convertToCelsius(data.feels) : _helpers.convertToFarenheit(data.feels)}</p>
    </div>
  </div>
  `;
        return html;
...
},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash":"3qBDj","../helpers":"hGI1E"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _clear() {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "convertTimeFR", ()=>convertTimeFR
);
parcelHelpers.export(exports, "convertTimeENG", ()=>convertTimeENG
);
parcelHelpers.export(exports, "getDay", ()=>getDay
);
parcelHelpers.export(exports, "convertToCelsius", ()=>convertToCelsius
);
parcelHelpers.export(exports, "convertToFarenheit", ()=>convertToFarenheit
);
parcelHelpers.export(exports, "convertMPH", ()=>convertMPH
);
parcelHelpers.export(exports, "convertKMH", ()=>convertKMH
);
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
const convertTimeFR = (unix)=>{
    const date = new Date(unix * 1000);
    const hours = date.getHours();
    return `${hours} h`;
};
const convertTimeENG = (unix)=>{
    const date = new Date(unix * 1000);
...
const convertToCelsius = (temp)=>{
    return _lodashDefault.default.round(Number(temp) - 273.15) + '°';
};
const convertToFarenheit = (temp)=>{
    return _lodashDefault.default.round(Number(temp - 273.15) * 9 / 5 + 32) + '°';
};
const convertMPH = (speed)=>{
    return _lodashDefault.default.round(speed * 2.24, 1) + ' mp/h';
};
const convertKMH = (speed)=>{
    return _lodashDefault.default.round(speed * 3.6, 1) + ' km/h';
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash":"3qBDj"}],"dTCHC":[function(require,module,exports) {
"use strict";
require("./noConflict");
...
class searchView extends _viewDefault.default {
    ...
    addHandlerSearchForm(handler) {
        ...
        this._parentElement.closest('form').addEventListener('submit', function(e) {
            e.preventDefault();
            passInputHandler();
        });
...
},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8gGt7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
class hourlyView extends _viewDefault.default {
    ...
    _generateMarkup(data, lang) {
        const html = `
    <div class="hour">
    <h2>${lang === 'fr' ? _helpers.convertTimeFR(data.hourNumber) : _helpers.convertTimeENG(data.hourNumber)}</h2>
    <img
      src="${data.icon}"
    />
    <h1>${lang === 'fr' ? _helpers.convertToCelsius(data.temperature) : _helpers.convertToFarenheit(data.temperature)}</h1>
...
},{"./View":"5cUXS","../helpers":"hGI1E","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aOUJX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
class weeklyView extends _viewDefault.default {
    ...
    _generateMarkup(data, i, lang) {
        const html = `
    <div class="day">
      <h1>${_helpers.getDay(data.dayName, lang)}</h1>
      <img
      src="${data.icon}"
      alt="weather-icon"
    />
    <div class="row-wrapper">
      <p>min</p>
      <p class="value">${lang === 'fr' ? _helpers.convertToCelsius(data.minTemp) : _helpers.convertToFarenheit(data.minTemp)}</p>
    </div>
    <div class="row-wrapper">
      <p>max</p>
...
exports.default = new weeklyView();

},{"./View":"5cUXS","../helpers":"hGI1E","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cuFOb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class mainView extends _viewDefault.default {
    ...
    languageDisplay(lang) {
        ...
        footer.textContent = fr ? 'Copyright ©2022 - Créé par FREɄD' : 'Copyright ©2022 - Created by FREɄD';
    }
}
exports.default = new mainView();

},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9GjUt","aenu9"], "aenu9", "parcelRequirebbde")
